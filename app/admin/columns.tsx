...
import { AssignDesignerDialog } from "@/components/AssignDesignerDialog"
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
              <AssignDesignerDialog projectId={row.original.id} />
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
            ...
            <DropdownMenuItem onClick={() => deleteProject(row.original.id)} className="text-red-600">
          Eliminar Proyecto
        </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
